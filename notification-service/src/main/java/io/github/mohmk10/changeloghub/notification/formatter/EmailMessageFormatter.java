...
public class EmailMessageFormatter implements MessageFormatter {
    ...
    public String format(Changelog changelog) {
        ...
        if (!breakingChanges.isEmpty()) {
            ...
            html.append("<h2>⚠️ Breaking Changes</h2>");
            html.append("<ul>");
        ...
        appendChangesSection(html, changes, Severity.DANGEROUS, "🟠 Dangerous Changes", "dangerous-section");
        appendChangesSection(html, changes, Severity.WARNING, "🟡 Warnings", "warning-section");
        appendChangesSection(html, changes, Severity.INFO, "🟢 Informational", "info-section");
